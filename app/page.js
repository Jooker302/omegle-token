  ...
  return (
    <>
      ...
      <div class="about">
        <div class="about-text">
          <p>
          Just like its namesake, the video chat platform Omegle, Omegle Token aims to create instant connections, but in the realm of cryptocurrencies. Embrace a new era of swift and secure transactions, paving the way for exciting possibilities in the digital economy. Join us on this journey as we bridge the gap between technology and human interactions, all powered by the innovative Omegle Token.
          </p>
        </div>
        <div class="about-image">
          <img
